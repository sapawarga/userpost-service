...
func (m *MockCommentI) GetCommentsByPostID(ctx context.Context, req *model.GetComment) ([]*model.CommentResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCommentsByPostID", ctx, req)
...
func (mr *MockCommentIMockRecorder) GetCommentsByPostID(ctx, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCommentsByPostID", reflect.TypeOf((*MockCommentI)(nil).GetCommentsByPostID), ctx, req)
}
